...
type CustomerSessionWorkspaceProps = {
  ...
  onBack: () => void;
  onTalkToCoach: () => void;
  onSaveSession: (result: { rating: "Easy" | "About Right" | "Challenging"; wins: string; difficult: string; notes: string }) => Promise<boolean>;
};
