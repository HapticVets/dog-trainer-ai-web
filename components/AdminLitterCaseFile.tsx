...
type Data = { litter: { litter_code: string; name: string; status: string; birth_date: string | null; estimated_due_date: string | null; is_public?: boolean; public_slug?: string | null; public_title?: string | null; public_summary?: string | null; public_status?: string | null }; puppies: Puppy[] };
