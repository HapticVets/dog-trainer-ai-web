...
type Puppy = { id: string; puppy_code: string; temporary_name: string | null; sex: string | null; collar_color: string | null; status: string; evaluationCount: number; latestEvaluationWeek: string | null };
type Data = { litter: { litter_code: string; name: string; status: string; birth_date: string | null; estimated_due_date: string | null }; puppies: Puppy[] };
